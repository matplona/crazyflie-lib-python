...
\label{ch:ecf}
\input{chapters/4_ecf/extended-crazyflie.tex}

\chapter{Communication Framework}
\label{ch:communication}
\input{chapters/5_communication/communication-framework.tex}

\chapter{Coordination Framework}
\label{ch:coordination}
\input{chapters/6_coordination/coordination-framework.tex}
...
\input{chapters/9_conclusion/conclusion.tex}
